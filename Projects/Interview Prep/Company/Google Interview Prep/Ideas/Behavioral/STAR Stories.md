...
## Name an unambiguous empirical belief that you believed within the last 3 years that you now think you were wrong about. Briefly explain why you changed your mind about it.
I had believed that AI would not be able to automate research in the advanced sciences, but this started to change after I read an OpenAI article detailing how a model revised a longstanding conjecture of the Erdős Unit Distance problem without human intervention. The model was able to generate an unexpected solution incorporating ideas from algebraic number theory, while performing reasoning that survived the review of expert mathematicians. Seeing a model exhibit creativity and connect diverging areas of study convinced me that AI are capable of much more than pattern matching or writing code. These abilities are also invaluable for research in fields such as biology, physics, and engineering. With how rapidly AI is advancing, it has made me wonder whether scientific research will resemble modern software engineering, where revising and verifying AI generated content is more prevalent than creating content from scratch.