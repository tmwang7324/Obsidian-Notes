...
| GliNER                      | Supports dynamic labelling.                                                |                                                                                          | Unable to parse through structured tables                                                                             |
| BERT                        | Bidirectional Encoder.                                                     |                                                                                          | Unable to parse through structured tables.<br><br>Model has limited generalizing capabilities for custom **labels.**  |
| spaCY                       |                                                                            |                                                                                          | Unable to parse through structured tables.<br>                                                                        |
| xlm-Roberta-Large           | An encoder-only text                                                       |                                                                                          | Pre-trained models miss crucial entities within tables.                                                               |
|                             |                                                                            |                                                                                          |                                                                                                                       |
| Qwen2.5:7b-Instruct-q4_K_M  | Local qwen2.5 LLM q4 quantized.                                            |                                                                                          | Extremely inclusive **Person** and **Organization** labels.<br><br>Easy to run on 8 VRAM, though latency is high.<br> |
| Qwen2.5:14-Instruct         |                                                                            |                                                                                          |                                                                                                                       |
| Google FLAN-T5              |                                                                            |                                                                                          |                                                                                                                       |
| gpt-4.1-mini                |                                                                            |                                                                                          |                                                                                                                       |
