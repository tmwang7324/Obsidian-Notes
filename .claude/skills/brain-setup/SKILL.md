---
name: brain-setup
description: Generate a personalized root CLAUDE.md by scanning the vault structure and interviewing the user. Use when setting up or initializing a new vault, or when CLAUDE.md is missing or contains only placeholder text.
---
